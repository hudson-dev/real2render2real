...
class LedLight(IsaacLabViser):
    def __init__(self, *args, **kwargs):
        ...
        self.dig_config_path = Path(f'{outputs_dir}/led_light2/dig/2025-04-07_130425/config.yml')
    ...
    def load_track_data(self):
        ...
        self.part_deltas = self.part_deltas[15:]
    ...
    def _reset_object_state(self):
        ...
        random_xyz = torch.randn_like(self.scene.env_origins) * 0.08
        random_xyz[:, 2] = 0.0
        
        z_rot = torch.rand((self.scene.num_envs,)) * 1.1 + onp.pi/2 - 0.5 #* 0.8 + onp.pi/2 - 0.4
